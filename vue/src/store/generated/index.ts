...
import CvmCosmosCvmcosmosCvmcosmos from './cvm-cosmos/cvmcosmos.cvmcosmos'
...
export default { 
  ...
  CvmCosmosCvmcosmosCvmcosmos: load(CvmCosmosCvmcosmosCvmcosmos, 'cvmcosmos.cvmcosmos'),
